...
<style lang='scss' scoped>
    ...
    .Task{
        ...
        &-container{
            ...
            &:nth-child(2):hover{
                animation: hover_animation 10s linear infinite;
            }
        }
        &-date{
            display: grid;
